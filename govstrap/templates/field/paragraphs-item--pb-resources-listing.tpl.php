...
<div class="resource-link external <?php print $classes; ?>"<?php print $attributes; ?>>
  <div class="content"<?php print $content_attributes; ?>>
    <a href="<?php print $resource_url; ?>" title="<?php print $resource_title; ?>" class="resource-title" target="_blank">
    ...
    <ul class="resource-file-list">
      ...
      <li>
        <a href="<?php print $resource_url; ?>" title="Open <?php print $resource_type; ?>" target="_blank">
